...
const source = readFileSync(resolve(__dirname, '..', 'src/game.ts'), 'utf8')
...
describe('Sky Hop canvas movement tuning', () => {
  ...
  it('lets the player reach a usable speed on the ground', () => {
    expect(groundTerminalSpeed).toBeGreaterThanOrEqual(maxSpeed * 0.8)
  })
